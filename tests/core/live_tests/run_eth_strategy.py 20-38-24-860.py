...
from strategies.live.eth_5min_macd_strategy_ui import ETH5MinMACDStrategyUI
...
def main():
    ...
    core.register_strategy('ETH5MinMACD', ETH5MinMACDStrategyUI)
    ...
    try:
        # Ejecutar estrategia ETH en paper trading
        _ = core.paper_trade(
